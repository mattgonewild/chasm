...
func newManager32(cfg Config) *Manager32 {
	manager := new(Manager32)
	InitManager32(manager, cfg)
	return manager
}
...
func (this *Manager32) Alive() int64 { return this.alive.Load() }
...
func (this *Manager32) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager32) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager32) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager32) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager32) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager32) newDataDaemon(id uuid.UUID) (Daemon, error) {
