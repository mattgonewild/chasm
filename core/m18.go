...
func newManager18(cfg Config) *Manager18 {
	manager := new(Manager18)
	InitManager18(manager, cfg)
	return manager
}
...
func (this *Manager18) Alive() int64 { return this.alive.Load() }
...
func (this *Manager18) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager18) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager18) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager18) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager18) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager18) newDataDaemon(id uuid.UUID) (Daemon, error) {
