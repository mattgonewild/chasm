...
func newManager24(cfg Config) *Manager24 {
	manager := new(Manager24)
	InitManager24(manager, cfg)
	return manager
}
...
func (this *Manager24) Alive() int64 { return this.alive.Load() }
...
func (this *Manager24) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager24) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager24) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager24) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager24) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager24) newDataDaemon(id uuid.UUID) (Daemon, error) {
