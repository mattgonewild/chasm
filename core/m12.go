...
func newManager12(cfg Config) *Manager12 {
	manager := new(Manager12)
	InitManager12(manager, cfg)
	return manager
}
...
func (this *Manager12) Alive() int64 { return this.alive.Load() }
...
func (this *Manager12) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager12) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager12) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager12) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager12) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager12) newDataDaemon(id uuid.UUID) (Daemon, error) {
