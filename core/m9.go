...
func newManager9(cfg Config) *Manager9 {
	manager := new(Manager9)
	InitManager9(manager, cfg)
	return manager
}
...
func (this *Manager9) Alive() int64 { return this.alive.Load() }
...
func (this *Manager9) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager9) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager9) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager9) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager9) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager9) newDataDaemon(id uuid.UUID) (Daemon, error) {
