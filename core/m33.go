...
func newManager33(cfg Config) *Manager33 {
	manager := new(Manager33)
	InitManager33(manager, cfg)
	return manager
}
...
func (this *Manager33) Alive() int64 { return this.alive.Load() }
...
func (this *Manager33) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager33) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager33) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager33) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager33) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager33) newDataDaemon(id uuid.UUID) (Daemon, error) {
