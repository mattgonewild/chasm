...
func newManager10(cfg Config) *Manager10 {
	manager := new(Manager10)
	InitManager10(manager, cfg)
	return manager
}
...
func (this *Manager10) Alive() int64 { return this.alive.Load() }
...
func (this *Manager10) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager10) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager10) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager10) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager10) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager10) newDataDaemon(id uuid.UUID) (Daemon, error) {
