...
func newManager27(cfg Config) *Manager27 {
	manager := new(Manager27)
	InitManager27(manager, cfg)
	return manager
}
...
func (this *Manager27) Alive() int64 { return this.alive.Load() }
...
func (this *Manager27) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager27) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager27) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager27) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager27) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager27) newDataDaemon(id uuid.UUID) (Daemon, error) {
