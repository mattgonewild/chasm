...
func newManager29(cfg Config) *Manager29 {
	manager := new(Manager29)
	InitManager29(manager, cfg)
	return manager
}
...
func (this *Manager29) Alive() int64 { return this.alive.Load() }
...
func (this *Manager29) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager29) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager29) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager29) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager29) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager29) newDataDaemon(id uuid.UUID) (Daemon, error) {
