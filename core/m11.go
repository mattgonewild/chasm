...
func newManager11(cfg Config) *Manager11 {
	manager := new(Manager11)
	InitManager11(manager, cfg)
	return manager
}
...
func (this *Manager11) Alive() int64 { return this.alive.Load() }
...
func (this *Manager11) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager11) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager11) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager11) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager11) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager11) newDataDaemon(id uuid.UUID) (Daemon, error) {
