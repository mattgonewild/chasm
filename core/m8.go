...
func newManager8(cfg Config) *Manager8 {
	manager := new(Manager8)
	InitManager8(manager, cfg)
	return manager
}
...
func (this *Manager8) Alive() int64 { return this.alive.Load() }
...
func (this *Manager8) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager8) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager8) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager8) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager8) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager8) newDataDaemon(id uuid.UUID) (Daemon, error) {
