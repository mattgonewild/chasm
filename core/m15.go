...
func newManager15(cfg Config) *Manager15 {
	manager := new(Manager15)
	InitManager15(manager, cfg)
	return manager
}
...
func (this *Manager15) Alive() int64 { return this.alive.Load() }
...
func (this *Manager15) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager15) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager15) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager15) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager15) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager15) newDataDaemon(id uuid.UUID) (Daemon, error) {
