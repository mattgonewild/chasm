...
func newManager21(cfg Config) *Manager21 {
	manager := new(Manager21)
	InitManager21(manager, cfg)
	return manager
}
...
func (this *Manager21) Alive() int64 { return this.alive.Load() }
...
func (this *Manager21) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager21) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager21) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager21) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager21) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager21) newDataDaemon(id uuid.UUID) (Daemon, error) {
