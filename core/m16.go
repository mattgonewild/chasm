...
func newManager16(cfg Config) *Manager16 {
	manager := new(Manager16)
	InitManager16(manager, cfg)
	return manager
}
...
func (this *Manager16) Alive() int64 { return this.alive.Load() }
...
func (this *Manager16) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager16) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager16) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager16) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager16) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager16) newDataDaemon(id uuid.UUID) (Daemon, error) {
