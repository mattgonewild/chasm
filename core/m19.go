...
func newManager19(cfg Config) *Manager19 {
	manager := new(Manager19)
	InitManager19(manager, cfg)
	return manager
}
...
func (this *Manager19) Alive() int64 { return this.alive.Load() }
...
func (this *Manager19) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager19) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager19) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager19) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager19) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager19) newDataDaemon(id uuid.UUID) (Daemon, error) {
