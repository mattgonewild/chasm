...
func newManager22(cfg Config) *Manager22 {
	manager := new(Manager22)
	InitManager22(manager, cfg)
	return manager
}
...
func (this *Manager22) Alive() int64 { return this.alive.Load() }
...
func (this *Manager22) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager22) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager22) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager22) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager22) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager22) newDataDaemon(id uuid.UUID) (Daemon, error) {
