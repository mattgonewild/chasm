...
func newManager34(cfg Config) *Manager34 {
	manager := new(Manager34)
	InitManager34(manager, cfg)
	return manager
}
...
func (this *Manager34) Alive() int64 { return this.alive.Load() }
...
func (this *Manager34) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager34) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager34) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager34) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager34) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager34) newDataDaemon(id uuid.UUID) (Daemon, error) {
