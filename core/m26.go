...
func newManager26(cfg Config) *Manager26 {
	manager := new(Manager26)
	InitManager26(manager, cfg)
	return manager
}
...
func (this *Manager26) Alive() int64 { return this.alive.Load() }
...
func (this *Manager26) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager26) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager26) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager26) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager26) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager26) newDataDaemon(id uuid.UUID) (Daemon, error) {
