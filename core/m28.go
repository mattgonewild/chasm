...
func newManager28(cfg Config) *Manager28 {
	manager := new(Manager28)
	InitManager28(manager, cfg)
	return manager
}
...
func (this *Manager28) Alive() int64 { return this.alive.Load() }
...
func (this *Manager28) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager28) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager28) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager28) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager28) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager28) newDataDaemon(id uuid.UUID) (Daemon, error) {
