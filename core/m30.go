...
func newManager30(cfg Config) *Manager30 {
	manager := new(Manager30)
	InitManager30(manager, cfg)
	return manager
}
...
func (this *Manager30) Alive() int64 { return this.alive.Load() }
...
func (this *Manager30) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager30) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager30) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager30) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager30) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager30) newDataDaemon(id uuid.UUID) (Daemon, error) {
