...
func newManager7(cfg Config) *Manager7 {
	manager := new(Manager7)
	InitManager7(manager, cfg)
	return manager
}
...
func (this *Manager7) Alive() int64 { return this.alive.Load() }
...
func (this *Manager7) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager7) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager7) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager7) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager7) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager7) newDataDaemon(id uuid.UUID) (Daemon, error) {
