...
func newManager31(cfg Config) *Manager31 {
	manager := new(Manager31)
	InitManager31(manager, cfg)
	return manager
}
...
func (this *Manager31) Alive() int64 { return this.alive.Load() }
...
func (this *Manager31) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager31) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager31) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager31) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager31) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager31) newDataDaemon(id uuid.UUID) (Daemon, error) {
