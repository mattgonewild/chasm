...
func newManager23(cfg Config) *Manager23 {
	manager := new(Manager23)
	InitManager23(manager, cfg)
	return manager
}
...
func (this *Manager23) Alive() int64 { return this.alive.Load() }
...
func (this *Manager23) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager23) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager23) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager23) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager23) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager23) newDataDaemon(id uuid.UUID) (Daemon, error) {
