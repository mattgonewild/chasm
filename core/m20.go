...
func newManager20(cfg Config) *Manager20 {
	manager := new(Manager20)
	InitManager20(manager, cfg)
	return manager
}
...
func (this *Manager20) Alive() int64 { return this.alive.Load() }
...
func (this *Manager20) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager20) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager20) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager20) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager20) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager20) newDataDaemon(id uuid.UUID) (Daemon, error) {
