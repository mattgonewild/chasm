...
func newManager14(cfg Config) *Manager14 {
	manager := new(Manager14)
	InitManager14(manager, cfg)
	return manager
}
...
func (this *Manager14) Alive() int64 { return this.alive.Load() }
...
func (this *Manager14) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager14) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager14) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager14) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager14) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager14) newDataDaemon(id uuid.UUID) (Daemon, error) {
