...
func newManager13(cfg Config) *Manager13 {
	manager := new(Manager13)
	InitManager13(manager, cfg)
	return manager
}
...
func (this *Manager13) Alive() int64 { return this.alive.Load() }
...
func (this *Manager13) newSymbolDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager13) newBookDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager13) newCandleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager13) newTradeDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager13) newScheduleDaemon(id uuid.UUID) (Daemon, error) {
...
func (this *Manager13) newDataDaemon(id uuid.UUID) (Daemon, error) {
