...
type forgeCore30 struct {
	manager  core.Manager30
...
func initCore30(fc *forgeCore30, cfg core.Config) {
	core.InitManager30(&fc.manager, cfg)
...
func newForge30(cfg core.Config) *forge30 {
	forge := new(forge30)
	forge.core = new(forgeCore30)
	initCore30(forge.core, cfg)
	return forge
}
