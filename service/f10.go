...
type forgeCore10 struct {
	manager  core.Manager10
...
func initCore10(fc *forgeCore10, cfg core.Config) {
	core.InitManager10(&fc.manager, cfg)
...
func newForge10(cfg core.Config) *forge10 {
	forge := new(forge10)
	forge.core = new(forgeCore10)
	initCore10(forge.core, cfg)
	return forge
}
