...
type forgeCore9 struct {
	manager  core.Manager9
...
func initCore9(fc *forgeCore9, cfg core.Config) {
	core.InitManager9(&fc.manager, cfg)
...
func newForge9(cfg core.Config) *forge9 {
	forge := new(forge9)
	forge.core = new(forgeCore9)
	initCore9(forge.core, cfg)
	return forge
}
