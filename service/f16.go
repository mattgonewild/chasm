...
func initCore16(fc *forgeCore16, cfg core.Config) {
	core.InitManager16(&fc.manager, cfg)
...
func newForge16(cfg core.Config) *forge16 {
	forge := new(forge16)
	forge.core = new(forgeCore16)
	initCore16(forge.core, cfg)
	return forge
}
