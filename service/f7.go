...
type forgeCore7 struct {
	manager  core.Manager7
...
func initCore7(fc *forgeCore7, cfg core.Config) {
	core.InitManager7(&fc.manager, cfg)
...
func newForge7(cfg core.Config) *forge7 {
	forge := new(forge7)
	forge.core = new(forgeCore7)
	initCore7(forge.core, cfg)
	return forge
}
