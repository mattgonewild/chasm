...
type forgeCore32 struct {
	manager  core.Manager32
...
func initCore32(fc *forgeCore32, cfg core.Config) {
	core.InitManager32(&fc.manager, cfg)
...
func newForge32(cfg core.Config) *forge32 {
	forge := new(forge32)
	forge.core = new(forgeCore32)
	initCore32(forge.core, cfg)
	return forge
}
