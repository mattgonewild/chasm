...
type forgeCore23 struct {
	manager  core.Manager23
...
func initCore23(fc *forgeCore23, cfg core.Config) {
	core.InitManager23(&fc.manager, cfg)
...
func newForge23(cfg core.Config) *forge23 {
	forge := new(forge23)
	forge.core = new(forgeCore23)
	initCore23(forge.core, cfg)
	return forge
}
