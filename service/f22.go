...
func initCore22(fc *forgeCore22, cfg core.Config) {
	core.InitManager22(&fc.manager, cfg)
...
func newForge22(cfg core.Config) *forge22 {
	forge := new(forge22)
	forge.core = new(forgeCore22)
	initCore22(forge.core, cfg)
	return forge
}
