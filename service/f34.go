...
type forgeCore34 struct {
	manager  core.Manager34
...
func initCore34(fc *forgeCore34, cfg core.Config) {
	core.InitManager34(&fc.manager, cfg)
...
func newForge34(cfg core.Config) *forge34 {
	forge := new(forge34)
	forge.core = new(forgeCore34)
	initCore34(forge.core, cfg)
	return forge
}
