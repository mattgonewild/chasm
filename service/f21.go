...
func initCore21(fc *forgeCore21, cfg core.Config) {
	core.InitManager21(&fc.manager, cfg)
...
func newForge21(cfg core.Config) *forge21 {
	forge := new(forge21)
	forge.core = new(forgeCore21)
	initCore21(forge.core, cfg)
	return forge
}
