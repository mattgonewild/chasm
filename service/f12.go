...
type forgeCore12 struct {
	manager  core.Manager12
...
func initCore12(fc *forgeCore12, cfg core.Config) {
	core.InitManager12(&fc.manager, cfg)
...
func newForge12(cfg core.Config) *forge12 {
	forge := new(forge12)
	forge.core = new(forgeCore12)
	initCore12(forge.core, cfg)
	return forge
}
