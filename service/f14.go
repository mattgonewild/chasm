...
type forgeCore14 struct {
	manager  core.Manager14
...
func initCore14(fc *forgeCore14, cfg core.Config) {
	core.InitManager14(&fc.manager, cfg)
...
func newForge14(cfg core.Config) *forge14 {
	forge := new(forge14)
	forge.core = new(forgeCore14)
	initCore14(forge.core, cfg)
	return forge
}
