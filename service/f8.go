...
type forgeCore8 struct {
	manager  core.Manager8
...
func initCore8(fc *forgeCore8, cfg core.Config) {
	core.InitManager8(&fc.manager, cfg)
...
func newForge8(cfg core.Config) *forge8 {
	forge := new(forge8)
	forge.core = new(forgeCore8)
	initCore8(forge.core, cfg)
	return forge
}
