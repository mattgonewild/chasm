...
type forgeCore19 struct {
	manager  core.Manager19
...
func initCore19(fc *forgeCore19, cfg core.Config) {
	core.InitManager19(&fc.manager, cfg)
...
func newForge19(cfg core.Config) *forge19 {
	forge := new(forge19)
	forge.core = new(forgeCore19)
	initCore19(forge.core, cfg)
	return forge
}
