...
type forgeCore11 struct {
	manager  core.Manager11
...
func initCore11(fc *forgeCore11, cfg core.Config) {
	core.InitManager11(&fc.manager, cfg)
...
func newForge11(cfg core.Config) *forge11 {
	forge := new(forge11)
	forge.core = new(forgeCore11)
	initCore11(forge.core, cfg)
	return forge
}
