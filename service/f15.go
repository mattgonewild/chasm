...
type forgeCore15 struct {
	manager  core.Manager15
...
func initCore15(fc *forgeCore15, cfg core.Config) {
	core.InitManager15(&fc.manager, cfg)
...
func newForge15(cfg core.Config) *forge15 {
	forge := new(forge15)
	forge.core = new(forgeCore15)
	initCore15(forge.core, cfg)
	return forge
}
