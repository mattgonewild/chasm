...
type forgeCore17 struct {
	manager  core.Manager17
...
func initCore17(fc *forgeCore17, cfg core.Config) {
	core.InitManager17(&fc.manager, cfg)
...
func newForge17(cfg core.Config) *forge17 {
	forge := new(forge17)
	forge.core = new(forgeCore17)
	initCore17(forge.core, cfg)
	return forge
}
