...
func initCore18(fc *forgeCore18, cfg core.Config) {
	core.InitManager18(&fc.manager, cfg)
...
func newForge18(cfg core.Config) *forge18 {
	forge := new(forge18)
	forge.core = new(forgeCore18)
	initCore18(forge.core, cfg)
	return forge
}
