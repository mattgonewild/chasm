...
type forgeCore24 struct {
	manager  core.Manager24
...
func initCore24(fc *forgeCore24, cfg core.Config) {
	core.InitManager24(&fc.manager, cfg)
...
func newForge24(cfg core.Config) *forge24 {
	forge := new(forge24)
	forge.core = new(forgeCore24)
	initCore24(forge.core, cfg)
	return forge
}
